  ...
  return (
    <main>
      ...
      <section className="about-us-main">
        ...
        <p>
          <strong>
            To provide the absolute best possible ecommerce bookstore
            experience.
          </strong>
        </p>
        ...
        <p>
          Welcome to Bookz!{" "}
          <strong>
            We aim to offer our customers a variety of the digitally available
            books.
          </strong>{" "}
          ...
          all of this while providing excellent customer service and friendly
          support. We always keep an eye on the latest trends in ecommerce and
          ...
          ecommerce industry. The interests of our customers are always top
