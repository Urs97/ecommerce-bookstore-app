                    ...
                    <Slide className="testimonial-slide">
                        <div className="wrapper">
                            <picture>
                                <source 
                                    type="image/webp" 
                                    srcSet={`${portrait_1_webp} 768w`}
                                />
                                <source 
                                    type="image/jpg" 
                                    srcSet={`${portrait_1_jpg} 768w`}
                                />
                    ...
                    <Slide className="testimonial-slide">
                        <div className="wrapper">
                            <picture>
                                <source 
                                    type="image/webp" 
                                    srcSet={`${portrait_2_webp} 768w`}
                                />
                                <source 
                                    type="image/jpg" 
                                    srcSet={`${portrait_2_jpg} 768w`}
                                />
                    ...
                    <Slide className="testimonial-slide">
                        <div className="wrapper">
                            <picture>
                                <source 
                                    type="image/webp" 
                                    srcSet={`${portrait_3_webp} 768w`}
                                />
                                <source 
                                    type="image/jpg" 
                                    srcSet={`${portrait_3_jpg} 768w`}
                                />
                                <img src={portrait_3_jpg} 
