...
export const AboutUsPhoto1 = () => {
  return (
    <picture>
      <source type="image/webp" srcSet={`${portrait_1_webp} 320w`} />
      <source type="image/jpg" srcSet={`${portrait_1_jpg} 320w`} />
      <img
        src={portrait_1_jpg}
...
export const AboutUsPhoto2 = () => {
  return (
    <picture>
      <source type="image/webp" srcSet={`${portrait_2_webp} 320w`} />
      <source type="image/jpg" srcSet={`${portrait_2_jpg} 320w`} />
      <img
        src={portrait_2_jpg}
